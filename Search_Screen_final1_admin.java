 ...
 * @author VARSHIL
 */
public class Search_Screen_final1_admin extends javax.swing.JFrame {
String selected_table=null;
    /**
     * Creates new form Search_Screen
     */
    public Search_Screen_final1_admin() {
        initComponents();
...
selected_table="USER1";
        DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                  tm.setRowCount(0);
                                  //USER_ID	NAME	DATE_OF_BIRTH	MEDICAL_INSURANCE	MEDICAL_HISTORY	STREET	CITY	STATE
                                  jTable1.getColumnModel().getColumn(0).setHeaderValue("USER_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("NAME");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("DATE_OF_BIRTH");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("MEDICAL_INSURANCE");
                   jTable1.getColumnModel().getColumn(4).setHeaderValue("MEDICAL_HISTORY");
                   jTable1.getColumnModel().getColumn(5).setHeaderValue("CITY");
                   jTable1.getColumnModel().getColumn(6).setHeaderValue("STREET");
                   jTable1.getColumnModel().getColumn(7).setHeaderValue("STATE");
...
selected_table="PATIENT";
        DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                tm.setRowCount(0);
                                  //PATIENT_ID	ORGAN_REQ	REASON_OF_PROCUREMENT	DOCTOR_ID	USER_ID
                                  jTable1.getColumnModel().getColumn(0).setHeaderValue("PATIENT_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("ORGAN_REQ");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("REASON_OF_PROCUREMENT");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("DOCTOR_ID");
                   jTable1.getColumnModel().getColumn(4).setHeaderValue("USER_ID");
...
selected_table="DONOR";
DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                   tm.setRowCount(0);
                                   //DONOR_ID	ORGAN_DONATED	REASON_OF_DONATION	ORGANIZATION_ID	USER_ID
  jTable1.getColumnModel().getColumn(0).setHeaderValue("DONOR_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("ORGAN_DONATED");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("REASON_OF_DONATION");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("ORGANIZATION_ID");
                   jTable1.getColumnModel().getColumn(4).setHeaderValue("USER_ID");
                   jTable1.getColumnModel().getColumn(5).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(6).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(7).setHeaderValue("");
...
selected_table="DOCTOR";
DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                   tm.setRowCount(0);
                                   //DOCTOR_ID	DOCTOR_NAME	DEPARTMENT_NAME	ORGANIZATION_ID
         jTable1.getColumnModel().getColumn(0).setHeaderValue("DOCTOR_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("DOCTOR_NAME");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("DEPARTMENT_NAME");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("ORGANIZATION_ID");
...
selected_table="ORGANIZATION";
DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                   tm.setRowCount(0);
                //ORGANIZATION_ID	ORGANIZATION_NAME	LOCATION	GOVERNMENT_APPROVED
         jTable1.getColumnModel().getColumn(0).setHeaderValue("ORGANIZATION_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("ORGANIZATION_NAME");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("LOCATION");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("GOVERNMENT_APPROVED");
                   jTable1.getColumnModel().getColumn(4).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(5).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(6).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(7).setHeaderValue("");
...
selected_table="ORGAN_AVAILABLE";
DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                   tm.setRowCount(0);
 //ORGAN_ID	ORGAN_NAME	DONOR_ID
         jTable1.getColumnModel().getColumn(0).setHeaderValue("ORGAN_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("ORGAN_NAME");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("DONOR_ID");
...
selected_table="TRANSACTION";
DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                   tm.setRowCount(0);
    //PATIENT_ID	ORGAN_ID	DONOR_ID	DATE_OF_TRANSACTION	STATUS
         jTable1.getColumnModel().getColumn(0).setHeaderValue("PATIENT_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("ORGAN_ID");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("DONOR_ID");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("DATE_OF_TRANSACTION");
...
selected_table="ORGANIZATION_HEAD";
DefaultTableModel tm=(DefaultTableModel)jTable1.getModel();
//                   tm.setRowCount(0);
                                   tm.setRowCount(0);
//ORGANIZATION_ID	EMPLOYEE_ID	NAME	DATE_OF_JOINING	TERM_LENGTH
         jTable1.getColumnModel().getColumn(0).setHeaderValue("ORGANIZATION_ID");
                   jTable1.getColumnModel().getColumn(1).setHeaderValue("EMPLOYEE_ID");
                   jTable1.getColumnModel().getColumn(2).setHeaderValue("NAME");
                   jTable1.getColumnModel().getColumn(3).setHeaderValue("DATE_OF_JOINING");
                   jTable1.getColumnModel().getColumn(4).setHeaderValue("TERM_LENGTH");
                   jTable1.getColumnModel().getColumn(5).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(6).setHeaderValue("");
                   jTable1.getColumnModel().getColumn(7).setHeaderValue("");
...
//                System.out.println("no: "+no+" name: "+name);
    ...
    DefaultTableModel model=(DefaultTableModel) jTable1.getModel();
        int seletedRowIndex=jTable1.getSelectedRow();
        if(selected_table.equals("USER1")){
            JPanel panel=new JPanel(new GridLayout(10, 5));
        JLabel t1=new JLabel(model.getValueAt(seletedRowIndex,0).toString());
       ...
       JTextField t5=new JTextField(10);
        ...
        JLabel l3=new JLabel("DATE_OF_BIRTH");
        JLabel l4=new JLabel("MEDICAL_INSURANCE");
        JLabel l5=new JLabel("MEDICAL_HISTORY");
        ...
        t5.setText(model.getValueAt(seletedRowIndex,4).toString());
        t6.setText(model.getValueAt(seletedRowIndex,5).toString());
        t7.setText(model.getValueAt(seletedRowIndex,6).toString());
        t8.setText(model.getValueAt(seletedRowIndex,7).toString());
        panel.add(l1);
        panel.add(t1);
...
st.executeUpdate("update user1 set name='"+t2.getText()+"' ,date_of_birth='"+t3.getText()+"' ,medical_insurance="+Integer.parseInt(t4.getText())+" , medical_history='"+t5.getText()+"',street='"+t6.getText()+"' ,city='"+t7.getText()+"' ,state='"+t8.getText()+"' where user_id="+Integer.parseInt(t1.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("PATIENT")){
       ...
       JTextField t5=new JTextField(10);
        ...
        JLabel l2=new JLabel("ORGAN_REQ");
        JLabel l3=new JLabel("REASON_OF_PROCUREMENT");
        JLabel l4=new JLabel("DOCTOR_ID");
        JLabel l5=new JLabel("USER_ID");
        t2.setText(model.getValueAt(seletedRowIndex,1).toString());
        t3.setText(model.getValueAt(seletedRowIndex,2).toString());
        t4.setText(model.getValueAt(seletedRowIndex,3).toString());
        t5.setText(model.getValueAt(seletedRowIndex,4).toString());
...
st.executeUpdate("update patient set organ_req='"+t2.getText()+"' ,REASON_OF_PROCUREMENT='"+t3.getText()+"' ,doctor_id="+Integer.parseInt(t4.getText())+" , user_id="+Integer.parseInt(t5.getText())+" where patient_id="+Integer.parseInt(t1.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("DONOR")){
...
st.executeUpdate("update donor set organ_donated='"+t2.getText()+"' ,REASON_OF_DONATION='"+t3.getText()+"' ,organization_id="+Integer.parseInt(t4.getText())+" , user_id="+Integer.parseInt(t5.getText())+" where donor_id="+Integer.parseInt(t1.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("DOCTOR")){
       ...
       JTextField t5=new JTextField(10);
        ...
        JTextField t7=new JTextField(10);
        JTextField t8=new JTextField(10);
        JLabel l1=new JLabel("DOCTOR_ID");
        JLabel l2=new JLabel("DOCTOR_NAME");
        JLabel l3=new JLabel("DEPARTMENT_NAME");
        JLabel l4=new JLabel("ORGANIZATION_ID");
        t2.setText(model.getValueAt(seletedRowIndex,1).toString());
        t3.setText(model.getValueAt(seletedRowIndex,2).toString());
        t4.setText(model.getValueAt(seletedRowIndex,3).toString());
...
st.executeUpdate("update doctor set doctor_name='"+t2.getText()+"' ,department_name='"+t3.getText()+"' ,organization_id="+Integer.parseInt(t4.getText())+"where doctor_id="+Integer.parseInt(t1.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("ORGANIZATION")){
       ...
       JTextField t5=new JTextField(10);
        ...
        JTextField t7=new JTextField(10);
        JTextField t8=new JTextField(10);
        JLabel l1=new JLabel("ORGANIZATION_ID");
        JLabel l2=new JLabel("ORGANIZATION_NAME");
        JLabel l3=new JLabel("LOCATION");
        JLabel l4=new JLabel("GOVERNMENT_APPROVED");
        t2.setText(model.getValueAt(seletedRowIndex,1).toString());
        t3.setText(model.getValueAt(seletedRowIndex,2).toString());
        t4.setText(model.getValueAt(seletedRowIndex,3).toString());
        panel.add(l1);
...
st.executeUpdate("update organization set organization_name='"+t2.getText()+"' ,location='"+t3.getText()+"' ,government_approved="+Integer.parseInt(t4.getText())+" where organization_id="+Integer.parseInt(t1.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("ORGAN_AVAILABLE")){
       ...
       JTextField t5=new JTextField(10);
        ...
        JTextField t7=new JTextField(10);
        JTextField t8=new JTextField(10);
        JLabel l1=new JLabel("ORGAN_ID");
        JLabel l2=new JLabel("ORGAN_NAME");
        JLabel l3=new JLabel("DONOR_ID");
        t2.setText(model.getValueAt(seletedRowIndex,1).toString());
        t3.setText(model.getValueAt(seletedRowIndex,2).toString());
        panel.add(l1);
        panel.add(t1);
...
st.executeUpdate("update organ_available set organ_name='"+t2.getText()+"' ,donor_id="+Integer.parseInt(t3.getText())+"  where organ_id="+Integer.parseInt(t1.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("TRANSACTION")){
            ...
            //PATIENT_ID	ORGAN_ID	DONOR_ID	DATE_OF_TRANSACTION	STATUS
               JPanel panel=new JPanel(new GridLayout(10, 5));
        JLabel t1=new JLabel(model.getValueAt(seletedRowIndex,0).toString());
        JLabel t2=new JLabel(model.getValueAt(seletedRowIndex,1).toString());
        JLabel t3=new JLabel(model.getValueAt(seletedRowIndex,2).toString());
        JTextField t4=new JTextField(10);
       JTextField t5=new JTextField(10);
        JTextField t6=new JTextField(10);
        JTextField t7=new JTextField(10);
        JTextField t8=new JTextField(10);
        JLabel l1=new JLabel("PATIENT_ID");
        JLabel l2=new JLabel("ORGAN_ID");
        JLabel l3=new JLabel("DONOR_ID");
        JLabel l4=new JLabel("DATE_OF_TRANSACTION");
...
st.executeUpdate("update transaction set date_of_transaction='"+t4.getText()+"' ,status='"+t5.getText()+"'where patient_id="+Integer.parseInt(t1.getText())+" and organ_id="+Integer.parseInt(t2.getText())+" and donor_id="+Integer.parseInt(t3.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        else if(selected_table.equals("ORGANIZATION_HEAD")){
       ...
       JTextField t5=new JTextField(10);
        ...
        JTextField t8=new JTextField(10);
        JLabel l1=new JLabel("ORGANIZATION_ID");
        JLabel l2=new JLabel("EMPLOYEE_ID");
        JLabel l3=new JLabel("NAME");
        JLabel l4=new JLabel("DATE_OF_JOINING");
        JLabel l5=new JLabel("TERM_LENGTH");
        t3.setText(model.getValueAt(seletedRowIndex,2).toString());
        t4.setText(model.getValueAt(seletedRowIndex,3).toString());
        t5.setText(model.getValueAt(seletedRowIndex,4).toString());
        panel.add(l1);
...
st.executeUpdate("update organization_head set name='"+t3.getText()+"' ,date_of_joining='"+t4.getText()+"' ,term_length="+Integer.parseInt(t5.getText())+"  where organization_id="+Integer.parseInt(t1.getText())+" and employee_id="+Integer.parseInt(t2.getText())+"");
        JOptionPane.showMessageDialog(rootPane, "VALUES UPDATED SUCCESSFULLY!","DONE",JOptionPane.PLAIN_MESSAGE);
        ...
        //System.out.println("Here"+jTable1.getRowCount());
               // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Screen_final1_admin().setVisible(true);
            }
        });
    }
